...
const TRANSLATIONS = {
  pt: {
    ...
    privacidade_p3: 'Também usamos o Google Analytics e o Meta Pixel (Facebook/Instagram) para entender, de forma agregada, como as pessoas navegam pelo site e avaliar o resultado dos nossos anúncios (páginas visitadas, produtos vistos, se a compra foi concluída) — isso não identifica você pessoalmente. Na hora de finalizar a compra, o Mercado Pago também coleta um identificador do seu dispositivo/navegador, usado exclusivamente para prevenir fraude em pagamentos com cartão.',
  ...
  en: {
    ...
    privacidade_p3: 'We also use Google Analytics and the Meta Pixel (Facebook/Instagram) to understand, in aggregate, how people browse the site and to measure our ad performance (pages visited, products viewed, whether a purchase was completed) — this does not personally identify you. When you check out, Mercado Pago also collects a device/browser identifier, used exclusively to prevent card payment fraud.',
  ...
  es: {
    ...
    privacidade_p3: 'También usamos Google Analytics y el Meta Pixel (Facebook/Instagram) para entender, de forma agregada, cómo las personas navegan por el sitio y evaluar el resultado de nuestros anuncios (páginas visitadas, productos vistos, si la compra se completó) — esto no te identifica personalmente. Al finalizar la compra, Mercado Pago también recopila un identificador de tu dispositivo/navegador, usado exclusivamente para prevenir fraude en pagos con tarjeta.',
  ...
  fr: {
    ...
    destaque3_title: 'Livraison dans tout le Brésil', destaque3_desc: 'Paiement sécurisé via Mercado Pago',
    ...
    footer_payment_note: 'Paiement traité en toute sécurité par Mercado Pago',
    ...
    cart_checkout_btn: 'Finaliser la commande', cart_checkout_note: 'Paiement traité en toute sécurité par Mercado Pago.',
    ...
    privacidade_p1: 'Lorsque vous achetez sur notre site, nous collectons : nom, e-mail, téléphone, adresse de livraison et CPF (identifiant fiscal brésilien). Le CPF est exigé par Mercado Pago pour évaluer le risque de la transaction et réduire les refus de carte — nous ne conservons pas votre CPF dans notre propre base de données, il est envoyé directement au processeur de paiement.',
    ...
    privacidade_p3: 'Nous utilisons aussi Google Analytics et le Meta Pixel (Facebook/Instagram) pour comprendre, de façon agrégée, comment les personnes naviguent sur le site et évaluer les performances de nos publicités (pages visitées, produits consultés, si l’achat a été finalisé) — cela ne vous identifie pas personnellement. Au moment de finaliser l’achat, Mercado Pago collecte aussi un identifiant de votre appareil/navigateur, utilisé exclusivement pour prévenir la fraude sur les paiements par carte.',
