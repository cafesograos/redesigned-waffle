...
const TRANSLATIONS = {
  pt: {
    ...
    privacidade_p1: 'Quando você compra no nosso site, coletamos: nome, e-mail, telefone e endereço de entrega. O CPF é pedido só pra validação no formulário — não é armazenado no nosso banco de dados nem compartilhado com o processador de pagamento.',
  ...
  en: {
    ...
    privacidade_p1: 'When you buy on our site, we collect: name, email, phone and delivery address. CPF (Brazilian tax ID) is only asked for form validation — it is not stored in our database or shared with the payment processor.',
  ...
  es: {
    ...
    privacidade_p1: 'Cuando compras en nuestro sitio, recopilamos: nombre, correo electrónico, teléfono y dirección de entrega. El CPF (documento fiscal brasileño) solo se pide para validar el formulario — no se guarda en nuestra base de datos ni se comparte con el procesador de pago.',
  ...
  fr: {
    ...
    privacidade_p1: 'Lorsque vous achetez sur notre site, nous collectons : nom, e-mail, téléphone et adresse de livraison. Le CPF (identifiant fiscal brésilien) est demandé uniquement pour valider le formulaire — il n’est ni conservé dans notre base de données ni partagé avec le processeur de paiement.',
